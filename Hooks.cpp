...
void Hooks::Initialize()
{
	...
	if (MH_Initialize() != MH_OK)
		Utility::Error("Failed to initialize MinHook.");
	...
	if (MH_EnableHook(MH_ALL_HOOKS) != MH_OK)
		Utility::Error("Failed to enable all hooks.");
...
void Hooks::Shutdown()
{
	...
	if (MH_DisableHook(MH_ALL_HOOKS) != MH_OK)
		Utility::Error("Failed to disable all hooks.");

	if (MH_Uninitialize() != MH_OK)
		Utility::Error("Failed to uninitialize MinHook.");
}
